...
Muuttujat `tuntipalkka = 23.0` ja `tunnit = 12` vaikuttavat muuttujassa `palkka` olevaan arvoon aluksi, mutta kasvatuskomento ei kuitenkaan kasvata muuttujan arvoa. Komento on siis mitä ilmeisimmin virheellinen. Ja toden totta, komento
